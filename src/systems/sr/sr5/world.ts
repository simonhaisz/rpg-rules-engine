...
import { SR5_Weapon, AresPredator, BrowningHighPower, HK227 } from "./weapon";
...
export function createStreetWorld(): SR5_World {
...
export function createOrganizedCrimeWorld(): SR5_World {
    const world = new SR5_World();
